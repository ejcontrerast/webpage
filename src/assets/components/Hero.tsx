     ...
     <div className="" >
      ...
      >
        ...
        <span className="text-red-500 text-[SayanSansRight] [-webkit-text-stroke:2px_#002f66] -ml-5 -mt-3">
          <span className="relative z-40 tracking-tighter text-[128px]">b</span>
          <span className="relative z-40 tracking-tighter -ml-2 text-[120px]">i</span>
          <span className="relative z-30 tracking-tighter -ml-2 text-[128px]">r</span>
          <span className="relative z-20 tracking-tighter -ml-2 text-[130px]">t</span>
          <span className="relative z-10 tracking-tighter -ml-2 text-[135px]">h</span>
          <span className="relative z-30 tracking-tighter -ml-2 text-[135px]">d</span>
          <span className="relative z-20 tracking-tighter -ml-2 text-[140px]">a</span>
          <span className="relative z-10 tracking-tighter -ml-2 text-[150px]">y</span>
        </span>
      </motion.h1>
      </div>
